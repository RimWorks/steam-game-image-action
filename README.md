...
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=rimworks_steam-game-image-action&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=rimworks_steam-game-image-action)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=rimworks_steam-game-image-action&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=rimworks_steam-game-image-action)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=rimworks_steam-game-image-action&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=rimworks_steam-game-image-action)
